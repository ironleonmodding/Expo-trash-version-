...
namespace Expo EXECUTOR alpha
{
    class Functions
    {
        public static string exploitdll = "expo.dll";//this is the name of your dll
        public static void Inject()
        {
            if (NamedPipes.NamedPipeExist(NamedPipes.luacpipename))//check if the pipe exist
            {
                MessageBox.Show("Already injected!", "MessageBoxButtons.OK, MessageBoxIcon.Asterisk);//if the pipe exist that's mean that we don't need to inject
                return;
            }
        ...
        public static OpenFileDialog openfiledialog = new OpenFileDialog
        {
            ...
            Title = "ExpoUI Lua/LuaC //OpenFileDialog Tittle
